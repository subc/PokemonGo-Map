...
from command.map_update_from_url4 import MapUpdateFromUrl4
...
manager.add_command('up_go_radar_20160813', MapUpdateFromUrl3())
manager.add_command('up', MapUpdateFromUrl4())
